...
const ScrollToTop = () => {
  ...
  return (
    <motion.button
      ...
      id='to-top-button'
      title='Go To Top'
      className='fixed z-50 bottom-20 right-10 border-0 w-14 h-14 rounded-full shadow-md bg-blue-500 p-4 text-white text-lg font-semibold transition-colors duration-300 flex justify-center items-center'
    >
