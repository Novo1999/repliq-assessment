        ...
        <div className='lg:flex lg:items-center lg:justify-between'>
          <div className='flex items-center justify-between'>
            ...
            <div className='flex lg:hidden'>
              <button
                onClick={toggleMenu}
                type='button'
                className='text-gray-500  hover:text-gray-600 -400 focus:outline-none focus:text-gray-600 -400'
          ...
          >
            ...
            <div className='flex items-center mt-4 lg:mt-0'>
              <button
                className='hidden mx-4 text-gray-600 transition-colors duration-300 transform lg:block  hover:text-gray-700 -400 focus:text-gray-700 -400 focus:outline-none'
